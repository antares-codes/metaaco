...
The build script we'll be using is contained in the MetaACO github repository ([contrib/gitian-build.py](https://https://github.com/metaaco/MACO/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the MetaACO repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/metaaco-maco/MetaACO/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, metaaco-detached-sigs, and metaaco GitHub repos.
