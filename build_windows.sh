...
# Create zip file of binaries
	strip -s metaaco/src/metaacod.exe metaaco/src/metaaco-cli.exe metaaco/src/metaaco-tx.exe metaaco/src/qt/metaaco-qt.exe
	cp metaaco/src/metaacod.exe metaaco/src/metaaco-cli.exe metaaco/src/metaaco-tx.exe metaaco/src/qt/metaaco-qt.exe .
	zip metaaco-windows.zip metaacod.exe metaaco-cli.exe metaaco-tx.exe metaaco-qt.exe
	rm -f metaacod.exe metaaco-cli.exe metaaco-tx.exe metaaco-qt.exe
