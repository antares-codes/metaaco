/* src/config/metaaco-config.h.  Generated from metaaco-config.h.in by configure.  */
/* src/config/metaaco-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/antares-codes/metaaco/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MetaACO Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MetaACO Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "metaaco"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://antares.codes/"
