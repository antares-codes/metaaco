 ...
 * MetaACO system. There are three: the main network on which people trade goods
...
public:
    ...
    int MetaACOBadBlockTime() const { return nMetaACOBadBlockTime; }
    int MetaACOBadBlocknBits() const { return nMetaACOBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nMetaACOBadBlockTime;
    unsigned int nMetaACOBadBlocknBits;
