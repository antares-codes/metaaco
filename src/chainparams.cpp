...
// Copyright (c) 2015-2022 The MetaACO Coin developers
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5369;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MetaACO starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 1000;
        nMetaACOBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nMetaACOBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
		...
		//vSeeds.push_back(CDNSSeedData("seed3", "seed3.antares.codes"));
		//vSeeds.push_back(CDNSSeedData("seed4", "seed4.antares.codes"));
        ...
        nStartMasternodePayments = 1656380400;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 1000;
        nMetaACOBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nMetaACOBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet metaaco addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet metaaco script addresses start with 'w'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet metaaco BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet metaaco BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet metaaco BIP44 coin type is '1' (All coin's testnet default)
