// Copyright (c) 2017-2018-2022 The MetaACO Coin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef MetaACO_ZMACOWALLET_H
#define MetaACO_ZMACOWALLET_H
...
public:
    CzMACOWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMACO(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMACO(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
