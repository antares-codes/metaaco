                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMACOPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzMACOPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzMACOPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMACOPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MetaACO RPC console.") + "<br>" +
