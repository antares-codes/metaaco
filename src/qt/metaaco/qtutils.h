...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, MetaACOGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, MetaACOGUI *gui, double posX = 3);
