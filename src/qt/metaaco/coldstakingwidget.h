...
#include "qt/metaaco/furabstractlistitemdelegate.h"
#include "qt/metaaco/txviewholder.h"
#include "qt/metaaco/tooltipmenu.h"
#include "qt/metaaco/sendmultirow.h"
#include "qt/metaaco/coldstakingmodel.h"
#include "qt/metaaco/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(MetaACOGUI* parent);
    ~ColdStakingWidget();
