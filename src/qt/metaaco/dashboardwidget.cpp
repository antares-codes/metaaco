...
#include "qt/metaaco/forms/ui_dashboardwidget.h"
#include "qt/metaaco/sendconfirmdialog.h"
#include "qt/metaaco/txrow.h"
...
DashboardWidget::DashboardWidget(MetaACOGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of MACO staked."));
    ...
    ui->labelAmountPiv->setText("0 MACO");
    ...
    ui->btnHowTo->setText(tr("How to get MACO"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("MACO")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZMACO;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair MACO, zMACO
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("MACO");
    set1 = new QBarSet("zMACO");
