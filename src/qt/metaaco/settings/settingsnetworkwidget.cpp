...
#include "qt/metaaco/settings/settingsnetworkwidget.h"
#include "qt/metaaco/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/metaaco/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MetaACOGUI* _window, QWidget *parent) :
