...
#include "qt/metaaco/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/metaaco/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MetaACOGUI* _window, QWidget *parent) :
