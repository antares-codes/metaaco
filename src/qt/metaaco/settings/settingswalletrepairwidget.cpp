...
#include "qt/metaaco/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/metaaco/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MetaACOGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MetaACOGUI::handleRestart()
