...
#include "qt/metaaco/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/metaaco/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MetaACOGUI* _window, QWidget *parent) :
