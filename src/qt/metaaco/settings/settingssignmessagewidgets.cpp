...
#include "qt/metaaco/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(MetaACOGUI* _window, QWidget *parent) :
