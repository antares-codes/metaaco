...
#include "qt/metaaco/forms/ui_addresseswidget.h"
#include "qt/metaaco/addresslabelrow.h"
#include "qt/metaaco/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(MetaACOGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter MetaACO address"));
