...
#ifndef MetaACO_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MetaACO_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MetaACO_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
