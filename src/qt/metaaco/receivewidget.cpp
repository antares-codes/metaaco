...
#include "qt/metaaco/forms/ui_receivewidget.h"
...
#include "qt/metaaco/addressholder.h"
...
ReceiveWidget::ReceiveWidget(MetaACOGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive MACO."));
