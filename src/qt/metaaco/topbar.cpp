...
#include "qt/metaaco/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/metaaco/lockunlock.h"
#include "qt/metaaco/qtutils.h"
#include "qt/metaaco/receivedialog.h"
...
TopBar::TopBar(MetaACOGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("MetaACO")
    updateDisplayUnit();
