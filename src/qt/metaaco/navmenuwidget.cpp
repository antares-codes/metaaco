...
#include "qt/metaaco/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(MetaACOGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-metaaco");
