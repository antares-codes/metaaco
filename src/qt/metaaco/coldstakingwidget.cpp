...
#include "qt/metaaco/coldstakingwidget.h"
#include "qt/metaaco/forms/ui_coldstakingwidget.h"
#include "qt/metaaco/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/metaaco/requestdialog.h"
#include "qt/metaaco/tooltipmenu.h"
#include "qt/metaaco/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(MetaACOGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your MACOs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept MACO delegation / Delegate MACO"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select MACO outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 MACO" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
