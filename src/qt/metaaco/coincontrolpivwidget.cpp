...
#include "qt/metaaco/coincontrolpivwidget.h"
#include "qt/metaaco/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select MACO Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("MACO");
    ...
    ui->labelValueAfter->setText("0.00 MACO");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 MACO");
    ui->labelValueFee->setText("0.00 MACO");
