...
// Copyright (c) 2015-2018-2022 The MetaACO Coin developers
...
/* MetaACO GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MetaACO"
#define QAPP_ORG_DOMAIN "antares.codes"
#define QAPP_APP_NAME_DEFAULT "MetaACO-Qt"
#define QAPP_APP_NAME_TESTNET "MetaACO-Qt-testnet"
