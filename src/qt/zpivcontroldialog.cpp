// Copyright (c) 2017-2020-2022 The MetaACO Coin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zMACO Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zMACO.";
            else if (!mint.isSeedCorrect)
                strReason = "The zMACO seed used to mint this zMACO is not the same as currently hold in the wallet";
            else
