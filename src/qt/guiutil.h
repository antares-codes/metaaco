...
/** Utility functions used by the MetaACO Qt UI.
 */
namespace GUIUtil
{
...
// Render MetaACO addresses in monospace font
...
// Parse "metaaco:" URI into recipient object, return true on successful parsing
