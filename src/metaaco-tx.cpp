...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MetaACO Core metaaco-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  metaaco-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded metaaco transaction") + "\n" +
                               "  metaaco-tx [options] -create [commands]   " + _("Create hex-encoded metaaco transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded metaaco transaction
