...
This means one can have an always-on metaacod instance running, and another local metaacod/metaaco-qt instance which connects to this node and receives blocks from it.
