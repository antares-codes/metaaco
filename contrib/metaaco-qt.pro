...
RESOURCES += src/qt/metaaco.qrc src/qt/metaaco_locale.qrc

TRANSLATIONS += src/qt/locale/metaaco_bg.ts \
                src/qt/locale/metaaco_de.ts \
                src/qt/locale/metaaco_en.ts \
                src/qt/locale/metaaco_es.ts \
                src/qt/locale/metaaco_fi.ts \
                src/qt/locale/metaaco_fr.ts \
                src/qt/locale/metaaco_it.ts \
                src/qt/locale/metaaco_ja.ts \
                src/qt/locale/metaaco_pl.ts \
                src/qt/locale/metaaco_pt.ts \
                src/qt/locale/metaaco_ru.ts \
                src/qt/locale/metaaco_sk.ts \
                src/qt/locale/metaaco_sv.ts \
                src/qt/locale/metaaco_vi.ts \
                src/qt/locale/metaaco_zh_CN.ts \
                src/qt/locale/metaaco_zh_TW.ts
