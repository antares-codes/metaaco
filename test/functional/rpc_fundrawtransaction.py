...
class RawTransactionsTest(MetaACOTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid metaaco address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid metaaco address" in e.error['message'])
