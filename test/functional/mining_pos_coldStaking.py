...
from test_framework.metaaco_node import MetaACOTestNode
...
class MetaACO_ColdStakingTest(MetaACOTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(MetaACOTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 MACO from the pot)
